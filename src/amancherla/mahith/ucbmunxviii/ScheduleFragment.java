...
public class ScheduleFragment extends Fragment {
	...
	ExpandableListView scheduleView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        scheduleView = (ExpandableListView) rootView.findViewById(R.id.schedExp);
        getData();
	...
	//Opens the appropriate day's schedule upon creation of the fragment. 
	private void openDaySchedule() {
        Calendar currentDay = Calendar.getInstance();
        int day = currentDay.get(Calendar.DATE);
        if (day == 9) {
        	scheduleView.expandGroup(3);
        } else if (day == 8) {
        	scheduleView.expandGroup(2);
        } else if (day == 8) {
        	scheduleView.expandGroup(1);
        } else {
